...
const PortfolioGallery: React.FC = () => {
    ...
    const projects: Project[] = [
        {
            ...
            liveUrl: "https://www.amazon.in/",
            githubUrl: "https://github.com/harsh-sangwan2002",
            featured: true,
        ...
        },
        {
            ...
            liveUrl: "https://www.healthifyme.com/in/",
            githubUrl: "https://github.com/harsh-sangwan2002",
            featured: true,
        ...
        },
        {
            ...
            githubUrl: "https://github.com/harsh-sangwan2002",
            liveUrl: "https://www.behance.net/search/projects/website%20redesign",
            featured: false,
        ...
        },
        {
            ...
            liveUrl: "https://dribbble.com/tags/saas-dashboard",
            githubUrl: "https://github.com/harsh-sangwan2002",
            featured: false,
    ...
    return (
        <div id="portfolio" className="py-24 bg-gradient-to-br from-purple-900 via-purple-800 to-blue-900 relative overflow-hidden">
            {/* Background Elements */}
                ...
                <div className="mt-20 text-center">
                    <div className="inline-block bg-gradient-to-r from-purple-600 to-blue-600 p-[2px] rounded-xl">
                        <div className="bg-white px-8 py-6 rounded-[10px]">
                            ...
                            <button className="cursor-pointer px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
