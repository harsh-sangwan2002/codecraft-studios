...
const ServiceShowcase: React.FC = () => {
    ...
    return (
        <div id="services" className="py-24 bg-gradient-to-br from-blue-50 via-white to-indigo-50 relative overflow-hidden">
            {/* Background Elements */}
                ...
                <div className="mt-20 text-center">
                    <div className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 p-[2px] rounded-xl">
                        <div className="bg-white/80 backdrop-blur-sm px-8 py-6 rounded-[10px]">
                            ...
                            <button
                                className="cursor-pointer px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl 
