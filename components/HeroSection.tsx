...
import { Code, Smartphone, Globe, Cuboid, Palette, Zap, ArrowRight, Play, Star, X } from 'lucide-react';
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
                    ...
                    <div className="text-center lg:text-left space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button className="cursor-pointer group px-8 py-4 bg-gradient-to-r from-yellow-400 to-orange-400 text-purple-900 rounded-xl font-semibold hover:from-yellow-500 hover:to-orange-500  transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl flex items-center justify-center space-x-2">
                                <Link href="#pricing">Start Your Project</Link>
                                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </button>

                            <button
                                className="cursor-pointer group px-8 py-4 bg-white/80 backdrop-blur-sm text-gray-700 rounded-xl font-semibold border-2 border-purple-100 hover:border-purple-300 hover:text-purple-600 transition-all duration-300 flex items-center justify-center space-x-2"
            ...
            {showVideoModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm transition-all">
                    ...
                    <div className="relative z-10 w-full max-w-4xl mx-auto p-4">
                        <button
                            className="cursor-pointer absolute top-2 right-2 text-white bg-black/60 rounded-full p-2 hover:bg-black/80 transition-colors z-20"
