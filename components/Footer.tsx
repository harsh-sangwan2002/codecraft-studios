...
const Footer: React.FC = () => {
    ...
    const contactInfo = [
        {
            icon: Mail,
            text: "hsangwan2002@gmail.com",
            href: "mailto:hsangwan2002@gmail.com",
        },
        {
            icon: Phone,
            text: "+91 8700437332",
    ...
    return (
        <footer id="footer" className="bg-gradient-to-br from-purple-900 via-purple-800 to-blue-900 relative overflow-hidden">
            {/* Background Elements */}
                                    ...
                                    {socialLinks.map((social) => {
                                        ...
                                        return (
                                            <motion.a
                                                ...
                                                className={`bg-white/10 rounded-lg flex items-center justify-center text-white transition-all duration-300 ${social.color} hover:bg-white/20 hover:scale-110`}
